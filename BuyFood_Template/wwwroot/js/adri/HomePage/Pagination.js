        ...
        success: function (data) {
            ...
            for (var i = (page * itemPerPage); i < items; i++) {
                ...
                for (let x = 0; x < Average_message_adri; x++) {
                    textForLoop += `<li><span class="fa fa-star checked" style="color: orange;font-size:25px""></span></li>`
                }
                for (let g = 0; g < 5 - Average_message_adri; g++) {
                    textForLoop += `<li><span class="fa fa-star checked" style="color: #d5d3cf;font-size:25px""></span></li>`
                }
                textForLoop += ` </ul>
